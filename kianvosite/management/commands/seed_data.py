...
<p><a href="/about/">Learn more about us</a> or <a href="/contact/">get in touch</a>.</p>""",
        ...
        hero_slides = [
            ...
            {
                'title': 'Building <span class="ks-gradient-text">East Africa\'s</span> Tech Talent',
                'subtitle': 'Training & Capacity Building',
                'description': 'From bootcamps to university partnerships, we equip the next generation of developers with practical software engineering skills.',
                'cta_primary_text': 'View Programmes',
                'cta_primary_url': '/announcements/',
            ...
            {
                'title': 'AI Research <span class="ks-gradient-text">for Social</span> Impact',
                'subtitle': 'Applied AI & Data Science',
                'description': 'We conduct applied research in machine learning, NLP, and computer vision — solving real-world problems in healthcare, agriculture, and education.',
            ...
            {
                'title': 'Trusted by <span class="ks-gradient-text">Organisations</span> Across Tanzania',
                'subtitle': 'Our Impact',
                'description': 'From universities to SMEs, our products and services are helping organisations digitise, automate, and grow.',
                'cta_primary_text': 'View Portfolio',
                'cta_primary_url': '/portfolio/',
                'cta_secondary_text': 'Partner With Us',
                'cta_secondary_url': '/contact/',
                'is_active': True,
                'order': 3,
            },
